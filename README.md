...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1f8f61,100:3967a5&height=220&section=header&text=LIFE-OS&fontSize=70&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=A%20consequence-aware%20operating%20system%20for%20your%20digital%20life&descAlignY=55&descSize=18" width="100%" alt="LIFE-OS banner" />

<br/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=3000&pause=900&color=1F8F61&center=true&vCenter=true&multiline=true&repeat=true&width=800&height=70&lines=One+change.+Every+place+it+matters.+%F0%9F%8C%90;Approved+by+you.+%E2%9C%85+Executed+within+bounds.+%F0%9F%94%92;Verified+against+the+source+of+truth.+%F0%9F%94%8E)](https://git.io/typing-svg)
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/FastAPI-React%20%2B%20TypeScript-009688?style=for-the-badge&logo=fastapi&logoColor=white" alt="FastAPI, React and TypeScript" />
  <br/>
...
![Visitor Badge](https://komarev.com/ghpvc/?username=9059Rohith-lifeos&label=Repo%20Views&color=1f8f61&style=for-the-badge)
...
sequenceDiagram
    actor U as 👤 User
    participant UI as 🖥️ React command center
...
<table>
  ...
  <tr>
    ...
    <td align="center"><img src="docs/screenshots/04-demo-applications.png" alt="LIFE-OS demo application records" width="480" /><br /><sub>🗂️ <b>6. Application records.</b> The downstream application state after execution.</sub></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td align="center"><img src="docs/screenshots/09-settings.png" alt="LIFE-OS settings page" width="480" /><br /><sub>⚙️ <b>Settings.</b> Workspace preferences and controls.</sub></td>
...
```mermaid
flowchart TD
    U[👤 User] --> UI[🖥️ React command center]
    UI --> API[⚡ FastAPI API]
    ...
    CTX --> POLICY[⚖️ Risk policy and approval hashes]
    POLICY --> EXEC[⚙️ Bounded execution state machine]
    EXEC --> VERIFY[🔍 Provider read-back verification]
    VERIFY --> AUDIT[🧾 Audit chain and evidence]
    AUDIT --> DB[(🗄️ SQLite or PostgreSQL)]
...
flowchart LR
    ...
    subgraph TRUSTED[✅ Bounded execution]
        E[⚙️ Allowlisted provider operations]
...
[![Star this repo](https://img.shields.io/github/stars/9059Rohith/LIFE-OS?style=social)](https://github.com/9059Rohith/LIFE-OS)
&nbsp;
[![Fork this repo](https://img.shields.io/github/forks/9059Rohith/LIFE-OS?style=social)](https://github.com/9059Rohith/LIFE-OS)

<sub>⬆️ <a href="#life-os">Back to top</a></sub>

</div>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1f8f61,100:3967a5&height=120&section=footer" width="100%" />
